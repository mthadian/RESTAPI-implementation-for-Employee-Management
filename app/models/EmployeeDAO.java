...
public class EmployeeDAO {
    ...
    public static List<Employee> all() {
        return (List<Employee>) JPA.em().createQuery("SELECT m FROM " + Employee.employees + " m ORDER BY id").getResultList();
    }
    ...
    public static List<Employee> paginate(Integer page, Integer size) {
        return (List<Employee>) JPA.em().createQuery("SELECT m FROM " + Employee.employees + " m ORDER BY id").setFirstResult(page*size).setMaxResults(size).getResultList();
    }
    ...
    public static Long count() {
        return (Long) JPA.em().createQuery("SELECT count(m) FROM " + Employee.employees + " m").getSingleResult();
    }
}